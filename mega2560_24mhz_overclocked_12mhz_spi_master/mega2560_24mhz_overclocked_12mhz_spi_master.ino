/*12mhz mega2560 duplex spi master overclocked 24mhz*

need to change out the 16mhz ceramic oscillator with a 24mhz crystal and matching caps
can use 20mhz also, need to change the hex to the 20mhz bootloader

add this entry to boards.txt in arduino:

##############################################################
mega24.name=Overclocked Mega 2560 24MHz
mega24.upload.protocol=wiring
mega24.upload.maximum_size=258048
mega24.upload.speed=115200
mega24.bootloader.low_fuses=0xF7
mega24.bootloader.high_fuses=0xD9
mega24.bootloader.extended_fuses=0xFD
mega24.bootloader.file=stk500v2/stk500boot_v2_mega2560_24.hex
#mega24.bootloader.file=stk500v2/stk500boot_v2_mega2560_22.hex
mega24.bootloader.unlock_bits=0x3F
mega24.bootloader.lock_bits=0x0F
mega24.build.mcu=atmega2560
mega24.build.f_cpu=24000000L
mega24.build.core=arduino
mega24.build.variant=mega
mega24.upload.tool=avrdude
mega24.upload.maximum_data_size=8192
mega24.bootloader.tool=avrdude
# default board may be overridden by the cpu menu
mega24.build.board=AVR_MEGA2560
##############################################################

add the stk500boot_v2_mega2560_24.hex to the arduino stk500boot_v2 folder

restart arduino ide

change board to the new Overclocked Mega 2560 24MHz slection, or 20mhz for 20mhz

burn new bootloader with usbasp to set new fuses

then upload sketches via usbasp or usb normally
*/
